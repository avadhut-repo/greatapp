...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1419330844738496)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1419647673738498)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1419959537738498)
,p_page_template_id=>wwv_flow_imp.id(1419330844738496)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1420270309738498)
,p_page_template_id=>wwv_flow_imp.id(1419330844738496)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1420505920738498)
,p_page_template_id=>wwv_flow_imp.id(1419330844738496)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1420872576738498)
,p_page_template_id=>wwv_flow_imp.id(1419330844738496)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1421122383738500)
,p_page_template_id=>wwv_flow_imp.id(1419330844738496)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1421467724738500)
,p_page_template_id=>wwv_flow_imp.id(1419330844738496)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1421719453738500)
,p_page_template_id=>wwv_flow_imp.id(1419330844738496)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1422041695738500)
,p_page_template_id=>wwv_flow_imp.id(1419330844738496)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1422349266738500)
,p_page_template_id=>wwv_flow_imp.id(1419330844738496)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1422605565738500)
,p_page_template_id=>wwv_flow_imp.id(1419330844738496)
