...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1452794319738543)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1453008443738543)
,p_plug_template_id=>wwv_flow_imp.id(1452794319738543)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1453344578738543)
,p_plug_template_id=>wwv_flow_imp.id(1452794319738543)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1453666628738543)
,p_plug_template_id=>wwv_flow_imp.id(1452794319738543)
,p_name=>'Sub Regions'
