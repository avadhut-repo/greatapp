...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1511216395738585)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1511536483738585)
,p_plug_template_id=>wwv_flow_imp.id(1511216395738585)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1511820411738585)
,p_plug_template_id=>wwv_flow_imp.id(1511216395738585)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512120826738585)
,p_plug_template_id=>wwv_flow_imp.id(1511216395738585)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512497509738585)
,p_plug_template_id=>wwv_flow_imp.id(1511216395738585)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1512724724738585)
,p_plug_template_id=>wwv_flow_imp.id(1511216395738585)
,p_name=>'Sub Regions'
