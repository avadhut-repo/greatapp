...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1455440067738545)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1455714290738545)
,p_plug_template_id=>wwv_flow_imp.id(1455440067738545)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1456095720738545)
,p_plug_template_id=>wwv_flow_imp.id(1455440067738545)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1456304844738546)
,p_plug_template_id=>wwv_flow_imp.id(1455440067738545)
,p_name=>'Button Start'
