...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1508087222738582)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1508352531738584)
,p_plug_template_id=>wwv_flow_imp.id(1508087222738582)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1508637152738584)
,p_plug_template_id=>wwv_flow_imp.id(1508087222738582)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1508923454738584)
,p_plug_template_id=>wwv_flow_imp.id(1508087222738582)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1509207993738584)
,p_plug_template_id=>wwv_flow_imp.id(1508087222738582)
,p_name=>'Sub Regions'
