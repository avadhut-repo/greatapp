...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1473162321738557)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1473487158738557)
,p_plug_template_id=>wwv_flow_imp.id(1473162321738557)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1473722921738557)
,p_plug_template_id=>wwv_flow_imp.id(1473162321738557)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1474009389738557)
,p_plug_template_id=>wwv_flow_imp.id(1473162321738557)
,p_name=>'Sub Regions'
