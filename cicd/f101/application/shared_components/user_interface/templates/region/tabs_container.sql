...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1522806050738592)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1523150171738592)
,p_plug_template_id=>wwv_flow_imp.id(1522806050738592)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1523493888738592)
,p_plug_template_id=>wwv_flow_imp.id(1522806050738592)
,p_name=>'Tabs'
