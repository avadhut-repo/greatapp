...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1493564555738575)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1493880820738575)
,p_plug_template_id=>wwv_flow_imp.id(1493564555738575)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1494195233738576)
,p_plug_template_id=>wwv_flow_imp.id(1493564555738575)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1494457098738576)
,p_plug_template_id=>wwv_flow_imp.id(1493564555738575)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1494781334738576)
,p_plug_template_id=>wwv_flow_imp.id(1493564555738575)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1495035698738576)
,p_plug_template_id=>wwv_flow_imp.id(1493564555738575)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1495375416738576)
,p_plug_template_id=>wwv_flow_imp.id(1493564555738575)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1495616391738576)
,p_plug_template_id=>wwv_flow_imp.id(1493564555738575)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1495958414738576)
,p_plug_template_id=>wwv_flow_imp.id(1493564555738575)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1496277434738576)
,p_plug_template_id=>wwv_flow_imp.id(1493564555738575)
,p_name=>'Sub Regions'
