...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1457903240738546)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1458223309738546)
,p_plug_template_id=>wwv_flow_imp.id(1457903240738546)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1458546204738546)
,p_plug_template_id=>wwv_flow_imp.id(1457903240738546)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1458817829738546)
,p_plug_template_id=>wwv_flow_imp.id(1457903240738546)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1459101343738546)
,p_plug_template_id=>wwv_flow_imp.id(1457903240738546)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1459403011738546)
,p_plug_template_id=>wwv_flow_imp.id(1457903240738546)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1459729195738548)
,p_plug_template_id=>wwv_flow_imp.id(1457903240738546)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1460058879738548)
,p_plug_template_id=>wwv_flow_imp.id(1457903240738546)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1460338021738548)
,p_plug_template_id=>wwv_flow_imp.id(1457903240738546)
,p_name=>'Sub Regions'
