...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1462599685738550)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1462858434738550)
,p_plug_template_id=>wwv_flow_imp.id(1462599685738550)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1463130218738550)
,p_plug_template_id=>wwv_flow_imp.id(1462599685738550)
,p_name=>'Sub Regions'
