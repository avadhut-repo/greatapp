...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1483923315738568)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1484209048738568)
,p_plug_template_id=>wwv_flow_imp.id(1483923315738568)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1484539444738568)
,p_plug_template_id=>wwv_flow_imp.id(1483923315738568)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1484879392738570)
,p_plug_template_id=>wwv_flow_imp.id(1483923315738568)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1485113592738570)
,p_plug_template_id=>wwv_flow_imp.id(1483923315738568)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1485451839738571)
,p_plug_template_id=>wwv_flow_imp.id(1483923315738568)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1485741567738571)
,p_plug_template_id=>wwv_flow_imp.id(1483923315738568)
,p_name=>'Sub Regions'
